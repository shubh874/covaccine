      ...
      >
        ...
        {data ? (
          data.map(data1 => {
            return (
              <div>
                <h2> Slots Availability ({data1 ? data1.date : 'No Date'})</h2>{' '}
                <br />
                {data1.available_capacity_dose1 !== 0 ||
                data1.available_capacity_dose2 !== 0 ? (
                  <div>
                    {' '}
                    <h5 style={{ color: '#228B22' }}>
                      Available dose1: {data1.available_capacity_dose1}
                    </h5>
                    <br />
                    <h5 style={{ color: '#228B22' }}>
                      Available dose2: {data1.available_capacity_dose2}
                    </h5>
                  </div>
                ) : (
                  <h5 style={{ color: '#ff0000' }}>Booked</h5>
                )}
                <h5>Centre name:</h5>
          ...
          <div className='card bg-light'>
            <article className='card-body mx-auto'>
              ...
              <p className='text-center'>
                You can also search for the current availability of the vaccines
                in your area.
              </p>
              ...
              <form onSubmit={openModal}>
                ...
                <div className='form-group'>
                  <button
                    type='submit'
                    onClick={fetchData}
                    className='btn sign_button btn-block'
                    id='submitBtn1'
                  >
                    {' '}
                    {loading ? (
